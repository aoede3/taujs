...
export type AppConfig = CoreAppConfig & {
  ...
  // contribution from a renderer factory. It carries the framework's compiler (scoped JSX ownership for
  // React; a fresh plugin pack for Vue) and the render-module contract the host validates the
  // entry-server against.
