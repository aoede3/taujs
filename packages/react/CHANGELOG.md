...
- [#100](https://github.com/aoede3/taujs/pull/100) [`fc30d7a`](https://github.com/aoede3/taujs/commit/fc30d7acac48e09b55725ae131df371b285fdade) Thanks [@aoede3](https://github.com/aoede3)! - `streamOptions.dataTimeoutMs` accepts the `0`/`Infinity` no-bound sentinel, matching `shellTimeoutMs`
...
- [#98](https://github.com/aoede3/taujs/pull/98) [`90d896b`](https://github.com/aoede3/taujs/commit/90d896b3f221bc9554889c89c8352077fe12504c) Thanks [@aoede3](https://github.com/aoede3)! - `streamOptions.shellTimeoutMs` is validated, with an upper bound Node can actually honour
  ...
  `ssrOptions.prerenderTimeoutMs` shares the same validator, so it gains the same upper bound, and its public type documents the bound and the sentinels alongside it.
...
- [#21](https://github.com/aoede3/taujs/pull/21) [`93c4b53`](https://github.com/aoede3/taujs/commit/93c4b537e4ea0c88a540bffe789ef25b0678657a) Thanks [@aoede3](https://github.com/aoede3)! - RFC 0004 (H2): `headContent` receives the route's resolved `attr.head` payload as
