...
/**
 * Create a Vue error handler with structured logging.
 *
 * Vue doesn't have error boundaries like React, so this provides a good default
 * app.config.errorHandler that integrates with your logger.
 *
 * @example
