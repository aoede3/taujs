...
τjs orchestrates Fastify, Vite, React, and Vue rather than wrapping them behind its own abstractions, so each ecosystem stays fully open to you:
...
- **React / Vue** - bring the component libraries, tooling, and patterns of whichever framework each app uses
