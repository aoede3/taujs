...
## Resolve the response before rendering
<div className="orchestration-layout">
  <div className="orchestration-layout__copy">

τjs defines a clear boundary: **everything required for an application response is orchestrated and resolved at the request boundary**.
...
τjs lets you evolve an application along two independent axes: its architecture and its UI framework.
