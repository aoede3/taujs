...
τjs lets you evolve your application along two independent axes: its architecture and its UI framework.

- Adopt orchestration one route at a time
- [Migrate between React, Vue and Solid](/guides/incremental-migration) without rewriting your application architecture
...
<CardGrid>
  ...
  <Card title="Incremental migration" icon="add-document">
    [Adopt τjs without rewrites](/guides/incremental-migration)
  </Card>
  ...
  <Card title="Architecture-aware AI" icon="add-document">
    [Expose your architecture through MCP rathar than relying on AI to infer it](/reference/mcp)
  </Card>
</CardGrid>
